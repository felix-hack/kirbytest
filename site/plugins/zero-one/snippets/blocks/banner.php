...
<div class="uk-inline-clip uk-transition-toggle" tabindex="0">
  ...
  <?php if($block->bannerStyle() == 'overlay'): ?>
    ...
    <?php endif ?>
  <div class="uk-overlay uk-position-small<?= $block->contentPosition() ?><?= $block->contentWidth() ?><?php e($block->centerText() == "true", ' uk-text-center') ?><?php e($block->contentBackground() == "background", ' uk-overlay-default') ?><?php e($block->contentBackground() == "overlay", ' uk-light') ?>">
