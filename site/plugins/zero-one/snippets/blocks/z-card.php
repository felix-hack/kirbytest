...
if ($image = $data->cardImage()->toFile()) {
    $alt            = $data->cardMediaAlt()->isNotEmpty() ? $data->cardMediaAlt() : $image->alt();
    $src            = $data->cardMediaResizeWidth()->isNotEmpty() ? $image->resize($data->cardMediaResizeWidth()->toInt())->url() : $image->url();
    $srcurl         = $image->url();
    $srcset         = $data->cardMediaResizeWidth()->isNotEmpty() ? $image->thumb(['width' => $data->cardMediaResizeWidth()->toInt(), 'format' => 'webp'])->url() : $image->thumb(['format' => 'webp'])->url();
    $width          = $data->cardMediaResizeWidth()->isNotEmpty() ? $image->resize($data->cardMediaResizeWidth()->toInt())->width() : $image->width();
    $height         = $data->cardMediaResizeWidth()->isNotEmpty() ? $image->resize($data->cardMediaResizeWidth()->toInt())->height() : $image->height();
}
...
<?php if($data->cardMediaSwitch()->isTrue() && $data->cardMediaPosition() == 'top' && $image = $data->cardImage()->toFile()): ?>
...
<?php if($data->cardMediaSwitch()->isTrue() && $data->cardMediaPosition() == 'bottom' && $image = $data->cardImage()->toFile()): ?>
