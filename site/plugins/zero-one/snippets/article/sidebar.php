...
<aside class="uk-margin-large-bottom">
  ...
  <div class="tm-sidebar-block">
    ...
    <ul class="uk-list uk-list-divider">
      ...
      <li>
        <a href="<?= url($page->parent()->url(), ['params' => ['category' => urlencode($category)]]) ?>">
  ...
  <div class="tm-sidebar-block">
    ...
    <ul class="uk-list uk-list-divider">
      <?php foreach ($all_articles->group(function ($p) { return $p->date()->toDate('Y'); }) as $year => $yearList): ?>
        <li>
          <a href="<?= url($page->parent()->url(), ['params' => ['year' => $year]]) ?>">
            <?= $year ?>
          </a>
  ...
  <div class="tm-sidebar-block">
    ...
    <div>
      ...
      <a href="<?= url($page->parent()->url(), ['params' => ['tag' => urlencode($tag)]]) ?>"><span class="uk-label">#<?= $tag ?></span></a>
      <?php endforeach ?>
    </div>
  </div>
  <?php endif ?>
