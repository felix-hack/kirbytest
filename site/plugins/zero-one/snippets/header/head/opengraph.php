<?php 
    ...
    $title  = $page->isHomePage() ? ($site->metaTitle()->isNotEmpty() ?  $site->metaTitle()->html() : $site->title()->html()) : ($page->metaTitle()->isNotEmpty() ? $page->metaTitle()->html() . $siteTitle : $page->title()->html() . $siteTitle) ;
