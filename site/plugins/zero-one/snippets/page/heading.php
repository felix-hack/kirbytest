...
$pageHeaderSize = $page->pageHeaderSize()->isNotEmpty() ? ' ' . $page->pageHeaderSize() : ($site->pageHeaderSize()->isNotEmpty() ? ' ' . $site->pageHeaderSize() : null);
...
<header class="uk-section uk-section-overlap uk-animation-slide-bottom-small<?= $pageHeaderSize ?><?php if($page->headerImagePosition()): ?> <?= $page->headerImagePosition() ?><?php endif ?><?php if($page->headerImageSize()): ?> <?= $page->headerImageSize() ?><?php endif ?><?php if($page->headerTextColor()): ?> <?= $page->headerTextColor() ?><?php endif ?>" sources="[{&quot;srcset&quot;: &quot;<?= $img->thumb(['format' => 'webp'])->url() ?>&quot;,&quot;type&quot;: &quot;image\/webp&quot;}]" data-src="<?= $img->url() ?>" style="background-color: <?= $page->headerOverlayColor() ?>; background-blend-mode: overlay; background-repeat:<?= $page->headerImageRepeat() ?>"<?php e($page->backgroundParalax() == "paralaxY", ' uk-parallax="bgy: -120;"') ?><?php e($page->backgroundParalax() == "paralaxX", ' uk-parallax="bgx: -100"') ?> uk-img="loading: eager">
<?php else: ?>
<header class="uk-section uk-section-overlap uk-animation-slide-bottom-small<?= $pageHeaderSize ?><?php if($page->headerTextColor()): ?> <?= $page->headerTextColor() ?><?php endif ?>" style="background-color: <?= $page->headerOverlayColor() ?>; background-blend-mode: overlay;">
<?php endif ?>
<?php elseif($site->headerImage()->isTrue()): ?>
<?php if($img = $site->header()->toFile()): ?>
<header class="uk-section uk-animation-slide-bottom-small<?= $pageHeaderSize ?><?php if($site->headerImagePosition()): ?> <?= $site->headerImagePosition() ?><?php endif ?><?php if($site->headerImageSize()): ?> <?= $site->headerImageSize() ?><?php endif ?><?php if($site->headerTextColor()): ?> <?= $site->headerTextColor() ?><?php endif ?>" sources="[{&quot;srcset&quot;: &quot;<?= $img->thumb(['format' => 'webp'])->url() ?>&quot;,&quot;type&quot;: &quot;image\/webp&quot;}]" data-src="<?= $img->url() ?>" style="background-color: <?= $site->headerOverlayColor() ?>; background-blend-mode: overlay; background-repeat:<?= $site->headerImageRepeat() ?>"<?php e($site->backgroundParalax() == "paralaxY", ' uk-parallax="bgy: -120"') ?><?php e($site->backgroundParalax() == "paralaxX", ' uk-parallax="bgx: -100"') ?> uk-img="loading: eager">
<?php else: ?>
<header class="uk-section uk-animation-slide-bottom-small<?= $pageHeaderSize ?><?php if($site->headerTextColor()): ?> <?= $site->headerTextColor() ?><?php endif ?>" style="background-color: <?= $site->headerOverlayColor() ?>; background-blend-mode: overlay;">
<?php endif ?>
<?php else: ?>
<header class="uk-section uk-animation-slide-bottom-small<?= $pageHeaderSize ?> uk-section-default">
<?php endif ?>
...
<?php if ($bottom = $slots->categories()): ?>
  <?= $bottom ?>
<?php else: ?>
