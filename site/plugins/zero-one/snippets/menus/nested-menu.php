...
?>
  <ul class="uk-navbar-nav">
    ...
    <li<?php e($item->isOpen(), ' class="uk-active"') ?>>
      ...
      <div class="uk-navbar-dropdown<?php e($item->megaMenu()->isTrue() && (2 <= $children->count()) && ($children->count() <= 4), ' uk-navbar-dropdown-width-' . ($item->megaMenuWidth()->isNotEmpty() ? $item->megaMenuWidth() : $children->count()), ($item->megaMenu()->isTrue() && $item->megaMenuWidth()->isNotEmpty() ? ' uk-navbar-dropdown-width-' . $item->megaMenuWidth() : null)) ?>" uk-dropdown="animation: uk-animation-slide-top-small; duration: 300; offset: 0; animate-out: true; flip: false;<?php e($site->menuPosition() == "left", ' shift: false;') ?>">
