...
?>
  <ul id="mobile-menu" class="uk-nav uk-nav-primary" aria-live="polite"<?php e($site->mobileNav() == "true", ' uk-nav="toggle: .subnav-toggle"') ?>>
    ...
    <?php if($site->menubuttonObject()->isNotEmpty() && ($site->rightnav()->isEmpty() or $site->rightnav() == "button")): ?>
    <?php $menubuttonObject = $site->menubuttonObject()->toObject(); ?>
    <li>
      <a href="<?= $menubuttonObject->link()->toUrl() ?>"><?= h($menubuttonObject->buttonText()) ?></a>
    </li>
    <?php else: ?>
