...
<section class="tm-project uk-grid-match uk-grid-large" uk-grid>
  <?php if($img = $product->cover()->toFile()): ?>
  ...
  <span class="tm-hover-img">
    <picture>
      ...
      <img src="<?= $img->crop($coverimg_width, $coverimg_height)->url() ?>"<?php e($site->siteBorderRadius() == "true", ' class="uk-border-rounded"') ?> alt="<?= $img->alt() ?>" width="<?= $coverimg_width ?>" height="<?= $coverimg_height ?>" loading="lazy">
    </picture>
  </span>
  </a>
  </div>
    ...
    <a href="<?= $product->url() ?>" class="uk-link-toggle">
      ...
      <div class="uk-inline-clip uk-transition-toggle<?php e($site->siteBorderRadius() == "true", ' uk-border-rounded') ?>" tabindex="0">
        <?php if($image = $product->gallery()->toFile()): ?>
          <picture>
            <source type="image/webp" srcset="<?= $img->thumb(['crop' => true, 'width' => $coverimg_width, 'height' => $coverimg_height, 'format' => 'webp'])->url() ?>" />
            <img src="<?= $img->crop($coverimg_width, $coverimg_height)->url() ?>"<?php e($site->siteBorderRadius() == "true", ' class="uk-border-rounded"') ?> alt="<?= $product->title()->html() ?>" width="<?= $coverimg_width ?>" height="<?= $coverimg_height ?>" loading="lazy">
          </picture>
          <?php if($image = $product->gallery()->first()->toFile()) : ?>
          <picture>
            <source type="image/webp" srcset="<?= $image->thumb(['crop' => true, 'width' => $coverimg_width, 'height' => $coverimg_height, 'format' => 'webp'])->url() ?>" />
            <img class="uk-transition-scale-up uk-position-cover" src="<?= $image->crop($coverimg_width, $coverimg_height)->url() ?>"<?php e($site->siteBorderRadius() == "true", ' class="uk-border-rounded"') ?> alt="<?= $image->alt() ?>" width="<?= $coverimg_width ?>" height="<?= $coverimg_height ?>" loading="lazy">
          </picture>
          <?php endif ?>
        <?php else: ?>
          <picture>
            <source type="image/webp" srcset="<?= $img->thumb(['crop' => true, 'width' => $coverimg_width, 'height' => $coverimg_height, 'format' => 'webp'])->url() ?>" />
            <img class="uk-transition-scale-up uk-transition-opaque" src="<?= $img->crop($coverimg_width, $coverimg_height)->url() ?>"<?php e($site->siteBorderRadius() == "true", ' class="uk-border-rounded"') ?> alt="<?= $product->title()->html() ?>" width="<?= $coverimg_width ?>" height="<?= $coverimg_height ?>" loading="lazy">
          </picture>
        <?php endif ?>
