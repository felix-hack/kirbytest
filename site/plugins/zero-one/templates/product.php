            ...
            <div class="uk-grid uk-grid-match" uk-grid>
                            ...
                            <div style="z-index: 0;" uk-scrollspy="cls: uk-animation-slide-bottom-small; delay: 100" uk-sticky="end: true; offset: 15; media: @s;">
                                <ul class="uk-slideshow-items" uk-lightbox>
                                    <li>
                                        <a href="<?= $img->url() ?>" alt="<?= $img->alt() ?>" data-no-swup data-caption="<?= $img->caption() ?>">
                                            <picture>
                                                <source type="image/webp" srcset="<?= $img->thumb(['crop' => true, 'width' => $coverimg_width, 'height' => $coverimg_height, 'format' => 'webp'])->url() ?>" />
                                                <img src="<?= $img->crop($coverimg_width, $coverimg_height)->url() ?>"<?php e($site->siteBorderRadius() == "true", ' class="uk-border-rounded"') ?> alt="<?= $img->alt() ?>" width="<?= $coverimg_width ?>" height="<?= $coverimg_height ?>">
                                            </picture>
                                        </a>
                                    </li>
                                <?php
                                ...
                                foreach($images as $image): ?>
                                    <li>
                                        ...
                                        <picture>
                                            <source type="image/webp" srcset="<?= $image->thumb(['crop' => true, 'width' => $coverimg_width, 'height' => $coverimg_height, 'format' => 'webp'])->url() ?>" />
                                            <img src="<?= $image->crop($coverimg_width, $coverimg_height)->url() ?>"<?php e($site->siteBorderRadius() == "true", ' class="uk-border-rounded"') ?> alt="<?= $image->alt() ?>" width="<?= $coverimg_width ?>" height="<?= $coverimg_height ?>" loading="lazy">
                                        </picture>
                                        </a>
                                    </li>
                                <?php endforeach ?>
                                ...
                                <div class="uk-visible@s uk-margin-small" uk-slider="finite: true">
                                    <div class="uk-position-relative uk-flex uk-flex-center">
                                        <div class="uk-slider-container uk-width-3-4">
                                            ...
                                            <?php $number = 0; foreach ($page->gallery()->toFiles() as $slide): $number++; ?>
                ...
                <div class="uk-width-1-2@s" uk-scrollspy="cls: uk-animation-slide-bottom-small; target: div; delay: 100">
                    ...
                    <?php else: ?>
                        ...
                        <div class="uk-margin<?php e($productVariation->variationLayout() == "horizontal", ' uk-form-horizontal') ?>">
                            ...
                            <div class="uk-form-control">
                                ...
                                <?php foreach ($productVariation->variationOptions()->toStructure() as $variationOption): ?>
                                    <option><?= $variationOption->optionName()->html() ?><?php e($variationOption->additionalPrice()->isNotEmpty(), ' (+' . $variationOption->additionalPrice()->price() . $site->defaultCurrencysymbol() . ')') ?></option>
                                <?php endforeach ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <?php endif ?>
                            <button id="pid_<?php e($page->snipcartProductid()->isNotEmpty(), $page->snipcartProductid(), $page->slug()) ?>" class="uk-button uk-button-primary snipcart-add-item"
                                ...
                                <?php $i = 1; foreach ($page->productVariations()->toStructure() as $productVariation): ?>
                                    ...
                                    <?php if($productVariation->variationType() == "options"): ?>
                                        data-item-custom<?= $c ?>-options="<?php $counter = 0; foreach ($productVariation->variationOptions()->toStructure() as $variationOption): ?><?= $variationOption->optionName()->html() ?><?php e($variationOption->additionalPrice()->isNotEmpty(), ' (+' . $variationOption->additionalPrice()->price() . $site->defaultCurrencysymbol() . ')') ?><?php e($variationOption->additionalPrice()->isNotEmpty(), '[+' . $variationOption->additionalPrice()->priceSnipcart() . ']') ?><?php e($counter !== count( $productVariation->variationOptions()->toStructure() ) - 1, '|') ?><?php $counter = $counter + 1; endforeach ?>"
                                    <?php endif ?>
                            ...
                            <script>
                            // Product ID
                            const button = document.querySelector('#pid_<?php e($page->snipcartProductid()->isNotEmpty(), $page->snipcartProductid(), $page->slug()) ?>')
                            // Quantity selector
                    ...
                    <div class="uk-text-small">
                        ...
                        <p><b><?= $site->labelProductcategory() ?></b> 
                         <a href="<?= url($page->parent()->url(), ['params' => ['category' => urlencode($page->category())]]) ?>"><?= Str::ucfirst($page->category()->tags()) ?></a>
                        </p>
                        <?php endif ?>
