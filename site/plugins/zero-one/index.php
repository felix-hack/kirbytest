...
Kirby::plugin('zero/zero-one', [
    'blueprints' => [
        ...
        'blocks/z-spacer' => __DIR__ . '/blueprints/blocks/z-spacer.yml',
      ...
      'snippets' => [
        ...
        'blocks/z-spacer' => __DIR__ . '/snippets/blocks/z-spacer.php',
        ...
        'routes' => [
           [
            ...
            'action'  => function ($id) {
                ...
                $field = new Kirby\Content\Field($page, 'inhalt', $text);
                $data  = [
                  'text' => $field->kt(),
                  'id'   => $id,
                  'page' => $page->url()
